...
function professional_theme_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['prof_settings']['slideshow']['slide6'] = array(
  		'#type' => 'fieldset',
  		'#title' => t('Slide 6'),
  		'#collapsible' => TRUE,
  		'#collapsed' => TRUE,
  );
  $form['prof_settings']['slideshow']['slide6']['slide6_head'] = array(
  		'#type' => 'textfield',
  		'#title' => t('Slide Headline'),
  		'#default_value' => theme_get_setting('slide6_head'),
  );
  $form['prof_settings']['slideshow']['slide6']['slide6_image_url'] = array(
  		'#type' => 'textarea',
  		'#title' => t('Image URL'),
  		'#default_value' => theme_get_setting('slide6_image_url'),
  );
  $form['prof_settings']['slideshow']['slide6']['slide6_desc'] = array(
  		'#type' => 'textarea',
  		'#title' => t('Slide Description'),
  		'#default_value' => theme_get_setting('slide6_desc'),
  );
  $form['prof_settings']['slideshow']['slide6']['slide6_url'] = array(
  		'#type' => 'textfield',
  		'#title' => t('Slide URL'),
  		'#default_value' => theme_get_setting('slide6_url'),
  );
  $form['prof_settings']['slideshow']['slide6']['slide6_alt'] = array(
  		'#type' => 'textfield',
  		'#title' => t('Image Alt Text'),
  		'#default_value' => theme_get_setting('slide_alt6'),
  );
