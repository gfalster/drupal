  ...
  <div id="container">
	...
	<div class="clear"></div>
      ...
      <li>
        ...
        <div class="entry-container">
          <header class="entry-header">
            <h2 class="entry-title"><a href="<?php print url($slide6_url); ?>"><?php print $slide6_head; ?></a></h2>
          </header><!-- .entry-header -->
          <div class="entry-summary">
                <?php print $slide6_desc; ?>
          </div><!-- .entry-summary -->
          <div class="clear"></div>
        </div><!-- .entry-container -->
            <a href="<?php print url($slide6_url); ?>">
		<?php if($slide6_img != '') { ?>
            <img src="<?php print $slide6_img; ?>" class="slide-image" alt="<?php print $slide6_alt; ?>" /> </a>
		<?php } else { ?>
            <img src="<?php print base_path() . drupal_get_path('theme', 'professional_theme') . '/images/slide-image-6.jpg'; ?>" class="slide-image" alt="<?php print $slide6_alt; ?>" /></a>
		<?php } ?>
         <div class="clear"></div>
        </article>
      </li>
